...
import { formatNumber, isNumberKey, getCaregiverNumber, getPrefixWard1, getPrefixRoom1, checkAuth, isOnPasteNumber } from '../../../services/functionService';
...
class EditNotification extends Component {
	...
	_renderData = async (id) => {
		...
		if (response.data.data != undefined) {
			...
			console.log(formatNumber(notification.salary))
			this.setState({
				...
				defaultNotification: {
					...
					salary: notification.salary.toString() !== 0 ? notification.salary : 0,
					salary_bonus: notification.salary_bonus.toString() !== 0 ? notification.salary_bonus : 0,
